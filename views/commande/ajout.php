        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <form action="<?= WEBROOT ?>?controller=commande&action=new" method="POST">
                ...
                <section class="bg-white p-5 rounded-lg shadow-xs border border-gray-200">
                    <h3 class="text-sm font-semibold uppercase tracking-wider text-indigo-700 mb-4">Informations Client
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="tel" name="tel_client" placeholder="Ex: 77XXXXXXX"
                                    class="flex-1 px-3 py-2 border border-gray-300 rounded-md shadow-xs focus:ring-1 focus:ring-indigo-500 focus:outline-none text-sm">
                                <button type="button"
                                    class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md font-medium text-sm transition shadow-xs cursor-pointer">OK</button>
                            </div>
                        </div>
                        <!-- Nom (Lecture seule / Désactivé) -->
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase mb-1">Nom</label>
                            <input type="text" readonly placeholder="Généré automatiquement"
                                class="w-full px-3 py-2 bg-gray-100 border border-gray-200 text-gray-500 rounded-md text-sm cursor-not-allowed font-medium">
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="max-w-xs">
                            <label class="block text-xs font-medium text-gray-700 uppercase mb-1">Référence
                                Produit</label>
                            <div class="flex gap-2">
                                <input type="text" name="ref_produit" placeholder="Ex: REF-001"
                                    class="flex-1 px-3 py-2 border border-gray-300 rounded-md shadow-xs focus:ring-1 focus:ring-indigo-500 focus:outline-none text-sm">
                                <button type="button"
                                    class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md font-medium text-sm transition shadow-xs cursor-pointer">OK</button>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                            <div>
                                ...
                                <input type="text" readonly placeholder="Produit recherché"
                            ...
                            <div>
                                ...
                                <input type="text" readonly placeholder="0.00 F CFA"
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-xs font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded border border-emerald-200">Dispo
                                        : 50</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-2 border-t border-gray-100 max-w-xs">
                            <label class="block text-xs font-medium text-gray-700 uppercase mb-1">Quantité à
                                commander</label>
                            <div class="flex gap-2">
                                <input type="number" name="qte_commande" min="1" value="1"
                                    class="flex-1 px-3 py-2 border border-gray-300 rounded-md shadow-xs focus:ring-1 focus:ring-indigo-500 focus:outline-none text-sm text-center font-semibold">
                                <button type="button"
                                    class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-md font-medium text-sm transition shadow-xs whitespace-nowrap cursor-pointer">Ajouter
                                    au panier</button>
                            </div>
                        </div>
                    </div>
            ...
            <section class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50/50">
                                ...
                                <td class="px-5 py-3 text-sm text-right">
                                    <button type="button"
                                        class="text-red-600 hover:text-red-900 font-semibold text-xs border border-red-200 bg-red-50 hover:bg-red-100 px-2.5 py-1 rounded transition cursor-pointer">Retirer</button>
                                </td>
                            </tr>
                            <!-- Exemple Ligne 2 -->
                            <tr class="hover:bg-gray-50/50">
                ...
                <div
                    ...
                    <button type="submit"
                        class="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-md font-semibold text-sm tracking-wide shadow-md hover:shadow-lg transition cursor-pointer">
