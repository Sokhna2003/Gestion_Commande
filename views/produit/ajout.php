<header class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-6">
    ...
    <p class="mt-1 text-sm text-gray-500">
        <?= isset($produit) ? "Modifiez les informations du produit ci-dessous" : "Remplissez le formulaire pour ajouter un produit" ?>
    </p>
</header>
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form action="<?= isset($produit) ? path('produit', 'update').'&id='.$produit['id_produit'] : path('produit', 'save') ?>" method="POST" class="grid grid-cols-2 gap-4">
